        ...
        ***********************************-->
        <div class="content-body">
            ...
            <div class="container-fluid mt-3">
                ...
                <h1>Welcome back <b><?php echo htmlspecialchars($_SESSION["name"]); ?> (<?php echo htmlspecialchars($_SESSION["username"]); ?>)</b> :)</h1><br>
                <div class="row">
                        ...
                        <div class="card gradient-1">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    ...
                                    <p class="text-white mb-0">+717 in 2020</p>
                                </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-2">
                            <div class="card-body">
                                <h3 class="card-title text-white">Rockets</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">231</h2>
                                    <p class="text-white mb-0">in 54 Locations</p>
                                </div>
                                <span class="float-right display-5 opacity-5"><i class="fa fa-rocket"></i></span>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-3 col-sm-6">
                        <div class="card gradient-3">
                            <div class="card-body">
                                <h3 class="card-title text-white">Data Monitoring</h3>
                                <div class="d-inline-block">
                                    <h2 class="text-white">24</h2>
                                    <p class="text-white mb-0">Active rockets</p>
                                </div>
                        ...
                        <div class="card gradient-4">
                            <div class="card-body">
                                ...
                                <div class="d-inline-block">
                                    ...
                                    <p class="text-white mb-0">3 Completed | 2020</p>
                                </div>
                                    ...
                                    <div class="todo-list">
                                        <div class="tdl-holder">
                                            <div class="tdl-content">
                                                <ul id="todo_list">
                                                    <li><label><input type="checkbox"><i></i><span>Google Code-in 2020</span><a href='#' class="ti-trash"></a></label></li>
                                                    <li><label><input type="checkbox" checked><i></i><span>Liquid Galaxy Controller</span><a href='#' class="ti-trash"></a></label></li>
                                                    <li><label><input type="checkbox"><i></i><span>OSC tasks</span><a href='#' class="ti-trash"></a></label></li>
                                                    <li><label><input type="checkbox" checked><i></i><span>Arduino WiFi Controller</span><a href='#' class="ti-trash"></a></label></li>
                                                </ul>
                                            </div>
                                            <div class="px-4">
